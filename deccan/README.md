# The Deccan, 1500–1830s

A single-page timeline collection. All content lives in `data/entries.js` (the 76 entries) and
...
The About page is `about.html`. Entry URLs take the form `#<entry-id>`, period URLs `#p1` … `#p5`.
