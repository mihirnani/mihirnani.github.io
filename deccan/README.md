# The Deccan, 1336–1830s

A single-page timeline collection. All content lives in `data/entries.js` (the 100 entries) and
...
The About page is `about.html`. Entry URLs take the form `#<entry-id>`, period URLs `#p1` … `#p6`.
