...
A single-page timeline collection. All content lives in `data/entries.js` (the entries) and
`data/periods.js` (the seven periods and their introductions); `app.js` renders the timeline,
