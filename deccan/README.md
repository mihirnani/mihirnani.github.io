...
A single-page timeline collection. The text lives as Markdown in the `curiosities-text`
repository beside this one (`deccan/entries/`, `deccan/periods/`, `chronology.md`,
`readings.md`); the files in `data/` are built from it and are not edited by hand:
...
Editing the Markdown and running the build is all that is needed to change the content of this page. The page shell
