/* entries.js – GENERATED by curiosities-text/tools/assemble.py from the Markdown in
   curiosities-text/deccan/entries. Edit the Markdown, not this file; the next build overwrites it. */
window.DECCAN_ENTRIES = [
 ...
 },
 {
  ...
  "kind": "place",
  "place": "Maski, Raichur district, Karnataka",
  "lat": 15.95,
  "lon": 76.65,
  "strap": "The wedge between the Krishna and the Tungabhadra is the oldest ground on the plateau, granite and gneiss with a gold belt through it; the two rivers that bound it were the only lines the rock offered, which is why two centuries of states fought over the wedge and none could hold it.",
  "body": "<p><a href=\"#raichur-doab-frontier\">The Raichur doab</a> is usually explained by its rivers. Explain it instead by what lies beneath, and the frontier becomes a fact of geology before it is a fact of politics. The doab sits on the Dharwar craton – the grey <a href=\"https://naniwadekar.com/basalt-and-laterite/#peninsular-gneiss\">Peninsular Gneiss</a> and the granites that welded it, with two Archaean greenstone belts threaded through it, one of which carries the gold of Hutti, worked in antiquity and mined today. Along its northern rim the gneiss dips under the limestones of the Bhima basin, and a few miles beyond, at Bijapur and Gulbarga, the Deccan Traps begin. The doab is therefore the place where the basalt country ends and the granite country starts: deep black soil on the basalt and the limestone to the north, black and red soils patched across the granite of the doab itself. Vijayanagara was a granite kingdom and the Bahmanis a basalt one, and the doab was the seam.</p>\n<p>Granite country has no natural frontiers except its rivers. The plateau here is a low, open surface of boulder hills and thin, patchy soil, crossable in any direction, and the only lines that could not be argued with were the Krishna, running east along the trap edge, and the Tungabhadra, running north-east off the craton. Every state that reached the doab claimed to the far river and could hold only to the near one, because the wedge between had nothing to defend it but the two forts on its granite hills, Raichur and Mudgal, and the crossings at Raichur’s fords were what the forts were for. Maski, in the middle of the doab, carries the minor rock edict in which Ashoka is named by name – the earliest sovereign claim on the wedge, cut into the same granite – and Raichur’s fort walls carry inscriptions of the Kakatiyas who held it in 1294 and of the Vijayanagara kings and sultans who took it in turn. The doab was fought for from 1362 to 1520 and changed hands repeatedly without ever changing shape.</p>\n<p>The rock also explains the doab’s value. It was not the richest land on either side – the black soil to the north and the irrigated valleys to the south were both better – but it was the crossing, and the crossing controlled the movement of horses, armies and grain between the two Deccans. When <a href=\"#talikota-1565\">Talikota</a> removed one of the two, the frontier vanished in a year: no one needed to hold a seam between two countries that had become one. The rivers went on flowing where they had, and in the twentieth century the Tungabhadra dam turned the granite wedge into the most irrigated ground in the region, which is the doab’s final joke on its history.</p>",
  "story": "The doab is the collection’s clearest case of a frontier the ground supplied and the states merely occupied: two rivers on a granite floor, a seam between basalt and gneiss, and nothing between them worth more than the crossing.",
  "sources": [
   {
    "title": "Richard M. Eaton and Phillip B. Wagoner, Power, Memory, Architecture: Contested Sites on India’s Deccan Plateau, 1300–1600 (Oxford University Press, 2014)",
    "url": "https://global.oup.com/academic/product/power-memory-architecture-9780198092216"
   ...
   {
    "title": "Geological Survey of India, Geology and Mineral Resources of Karnataka (Miscellaneous Publication 30, part VII)",
    "url": "https://prod-qt-images.s3.amazonaws.com/indiawaterportal/import/sites/default/files/iwp2/Report_Karnataka_State_Geology_and_Mineral_Maps_Geological_Survey_of_India.pdf"
   },
   {
    "title": "Wikipedia, ‘Maski’",
    "url": "https://en.wikipedia.org/wiki/Maski"
   }
  ],
  "related_maps": [
 ...
 {
  "id": "gajapatis-of-orissa",
  "title": "The Gajapatis of Orissa",
  "date_label": "1435–1541",
  "year": 1435,
  "year_end": 1541,
  "period": 1,
  "polities": [
  ...
  "lat": 20.46,
  "lon": 85.88,
  "strap": "The Suryavamsi kings of Orissa – Kapilendra, Purushottama, Prataparudra – pushed down the Andhra coast for eighty years and were the third power of the Deccan’s first two periods, until Krishnadevaraya drove them back to the Krishna.",
  "body": "<p>Kapilendra Deva took the throne of Orissa in 1434–35 at the end of the Eastern Ganga line and gave his house the title Gajapati, lord of elephants. In the scheme the inscriptions of the age use, that was one of three sovereignties in the subcontinent, beside the Narapati, lord of men, which Vijayanagara claimed, and the Ashvapati, lord of horses, which was the sultans’ share; the title was a programme, and for a generation the Gajapatis acted on it. Kapilendra’s armies came down the coast through the <a href=\"#reddi-velama-kingdoms\">Reddi and Velama country</a>, took Rajahmundry and Kondavidu in the 1450s, intervened in the Bahmani succession, and by the 1460s were raiding far to the south. Oriya tradition and the inscriptions claim Kanchi and a tribute from the Tamil country, and Vijayanagara under Mallikarjuna could not stop them.</p>\n<p>Purushottama (1467–97) held the Andhra conquests and lost the far south. His son Prataparudra (1497–1540) inherited a frontier on the Krishna that Vijayanagara now meant to move, and <a href=\"#krishnadevaraya\">Krishnadevaraya</a>’s eastern war of 1513–19 was the longest campaign of his reign. Udayagiri, the hill fort at the southern end of the Gajapati domain, fell in 1514 after a siege of more than a year; Kondavidu in 1515, with a Gajapati prince among the prisoners; then Kondapalli, Rajahmundry and Simhachalam, where the king had his victory recorded on the temple walls, and a march to the Gajapati capital at Cuttack. The peace of 1519 gave Vijayanagara everything south of the Krishna and gave Krishnadevaraya a Gajapati princess as a queen. The river became the frontier between the two Hindu kingdoms and, within a few years, the line along which Golconda advanced instead.</p>\n<p>The Gajapatis did not long survive the settlement. Prataparudra’s successors were murdered in turn, a minister’s family took the throne in 1541, and the Qutb Shahs, then the Mughals, absorbed the coast the dynasty had ruled; Kondavidu and Kondapalli, which had passed from Reddi to Gajapati to Raya within a lifetime, were Golconda’s by the middle of the century.</p>\n<p>The Gajapati century matters here because it breaks the symmetry of ‘two Deccans’. For eighty years there were three sovereignties on the plateau’s eastern edge, and the third was Hindu, claimed the same imperial titles as Vijayanagara, and fought it as readily as it fought the sultans. The coalition politics of the 1560s were rehearsed on the Krishna frontier a generation earlier, with Orissa in the third seat.</p>",
  "story": "",
  "sources": [
   {
    "title": "Burton Stein, Vijayanagara (The New Cambridge History of India, I.2) (Cambridge University Press, 1989)",
   ...
   {
    "title": "Wikipedia, ‘Gajapati Empire’",
 ...
 {
  "id": "chauth-and-sardeshmukhi",
  "title": "Chauth and sardeshmukhi",
  "date_label": "c. 1665–1818",
  "year": 1670,
  "year_end": 1818,
  "period": 4,
  "polities": [
  ...
  "lat": 17.68,
  "lon": 74.0,
  "strap": "The quarter and the tenth: the Maratha claim to a fixed share of other sovereigns’ revenue, first levied by Shivaji, chartered by the emperor in 1719, and the legal form that shared sovereignty took in the eighteenth-century Deccan.",
  "body": "<p>Chauth was a quarter. In the western Deccan of the seventeenth century the word already meant a share of the land revenue paid to a power that could otherwise ravage a district – the Portuguese of Daman paid it to the Koli chiefs of Ramnagar for the peace of their northern villages – and Shivaji made it a claim of state. From the 1660s his officers demanded a fourth of the assessed revenue of Mughal and Bijapuri districts that he did not govern, in Khandesh and the Surat country among others, in return for leaving them alone. The payment did not transfer the district, only a fraction of its income: a Mughal faujdar and a Maratha collector might work the same villages in the same season. Sardeshmukhi was a further tenth, claimed on a different ground. The sardeshmukh was the chief of the hereditary district headmen, and Shivaji asserted the office over the whole of his swarajya as a right older than any sultan or emperor, which none of them had conferred and none could withdraw.</p>\n<p>The two claims paid for the long war after 1689. Rajaram at Jinji and Tarabai after him could not maintain an army from a territory they did not hold, so they granted their commanders the right to collect chauth and sardeshmukhi from Mughal districts, as saranjam, and the commanders collected what they could; the Maratha polity that emerged after 1707 was in large part a federation of such grants. <a href=\"#shahu-and-the-sanads-1719\">The sanads of 1719</a> then gave the arrangement an imperial seal. The emperor granted Shahu the chauth and sardeshmukhi of the six Mughal subahs of the Deccan – Khandesh, Berar, Aurangabad, Bidar, Bijapur and Hyderabad – and the Marathas undertook to keep the peace they were being paid for. Under the Peshwa’s rules the chauth was itself divided: a quarter of it, the babti, went to the Chhatrapati; a small share, the sahotra, to the Pant Sachiv; and the bulk, the mokasa, to the commanders who collected it and kept horse on it. Sardeshmukhi went to the king.</p>\n<p>What this meant for sovereignty is the subject of André Wink’s <em>Land and Sovereignty in India</em>. On his reading the Maratha claim was not a tribute exacted from a defeated empire but a share in it – a co-sovereignty negotiated district by district, in which the Mughal governor kept his office and the Maratha kamavisdar kept his fourth, and each recognised the other as the condition of collecting anything at all. The Nizam’s Hyderabad after 1724 lived under exactly this partition, enforced at <a href=\"#palkhed-1728\">Palkhed</a> and contested to Kharda; so did Malwa and Gujarat once the Peshwa carried the claim north of the Narmada. The Company inherited the claim in 1818 with the Peshwa’s other rights and let it lapse, because a paramount power collects revenue and does not share it.</p>",
  "story": "Chauth is the mechanism behind the collection’s argument: the fraction that let two states hold one territory and one taxpayer with a legal title each. Most of the entries from Palkhed to the Peshwa’s surrender are, underneath, about who held it.",
  "sources": [
   {
    "title": "André Wink, Land and Sovereignty in India: Agrarian Society and Politics under the Eighteenth-Century Maratha Svarājya (Cambridge University Press, 1986)",
    "url": "https://archive.org/details/landsovereigntyi0000wink"
   ...
   {
    "title": "G. S. Sardesai, New History of the Marathas, 3 vols (Phoenix Publications, Bombay, 1946–48)",
    "url": "https://archive.org/details/dli.ernet.236030"
   },
   {
    "title": "Wikipedia, ‘Chauth’",
 ...
 {
  "id": "narayanrao-murder-1773",
  "title": "The murder of Narayanrao and Ramshastri’s verdict",
  "date_label": "30 August 1773",
  "year": 1773,
  "year_end": 1774,
  "period": 5,
  "polities": [
  ...
  "kind": "event",
  "place": "Shaniwar Wada, Pune, Maharashtra",
  "lat": 18.519,
  "lon": 73.855,
  "strap": "The killing of the Peshwa in his own palace on 30 August 1773, the judge who found his uncle responsible, and the council of ministers that ruled for twenty years in the name of a child born after his father’s death.",
  "body": "<p>Narayanrao was seventeen when he became Peshwa in November 1772 on the death of his brother <a href=\"#madhavrao-i\">Madhavrao</a>, and he held the office for nine months. His uncle Raghunathrao, who had expected the succession and had already been confined once for intriguing against Madhavrao, was under house arrest in the Shaniwar Wada; the Gardis, the Peshwa’s own regiment of matchlockmen under Sumer Singh, had a grievance over pay and a grudge over their treatment. On 30 August 1773, during the Ganesh festival, a party of Gardis broke into the palace and killed the Peshwa and several of those who tried to shelter him. The tradition that Raghunathrao’s written order to seize his nephew – <em>dharave</em> – was altered by his wife Anandibai to <em>marave</em>, kill him, is old and cannot be proved; the order to seize is not doubted.</p>\n<p>Raghunathrao took the seals. What followed was unusual in any state of the age. Ramshastri Prabhune, the nyayadhish or chief judge of the Peshwa’s court, examined the killing, named Raghunathrao as responsible, and pronounced that no penance short of giving up the office could expiate it; he then left Pune rather than serve the man he had condemned. The verdict had no army behind it and could not be executed, but it gave the opposition its ground. Over the following months the leading ministers and sardars – Sakharam Bapu Bokil, <a href=\"#nana-phadnavis\">Nana Phadnavis</a>, Trimbakrao Pethe, with Holkar and Scindia – formed the council that Maratha historians call the Barbhai, the twelve brethren, in the name of Narayanrao’s widow Gangabai and the child she was carrying. Sawai Madhavrao was born at Purandar fort on 18 April 1774 and invested as Peshwa at forty days old. Raghunathrao, beaten in the field, fled to the Company at Surat and signed away Salsette and Bassein for its support: the war that ended at <a href=\"#wadgaon-salbai\">Wadgaon and Salbai</a> begins here, and so does the regency that governed Pune until 1795.</p>\n<p>The episode is a sovereignty judged from within. A state whose power ran through the Chhatrapati’s minister had, in Ramshastri, an officer whose authority came from the dharma he administered rather than the office he served, and who could say that a Peshwa had forfeited the right to be one. The council that acted on his finding ruled for a generation without a Peshwa of age; and the Company, which had backed the loser, learned that Maratha sovereignty was not to be captured by capturing a claimant.</p>",
  "story": "",
  "sources": [
   {
    "title": "Stewart Gordon, The Marathas 1600–1818 (The New Cambridge History of India, II.4) (Cambridge University Press, 1993)",
   ...
   {
    "title": "Wikipedia, ‘Narayan Rao’",
    "url": "https://en.wikipedia.org/wiki/Narayan_Rao"
   },
   {
    "title": "Wikipedia, ‘Ram Shastri Prabhune’",
 ...
 },
 {
  ...
  "story": "Mangalore is the high-water mark of Mysore as an independent sovereign among the Deccan powers. The treaty’s symmetry, mutual restitution and mutual release, is something the Company did not offer again. Tipu’s assumption of royal titles, completed when he took the title of padshah in 1787, announces a change in the layered order: the fiction that Mysore’s Muslim rulers governed for the Wodeyar raja was dropped, and a new dynasty claimed sovereignty in its own right, a claim the next two wars were fought to extinguish.",
  "sources": [
   {
    "title": "Kate Brittlebank, Tiger: The Life of Tipu Sultan (Juggernaut, New Delhi, 2016)",
    "url": "https://www.juggernaut.in/products/tiger-the-life-of-tipu-sultan"
 ...
 },
 {
  ...
  "story": "The embassies show a Deccan ruler treating sovereignty as something exercised in a world of states, reaching past the Mughal emperor and the Company to the Ottoman caliph and the French king for recognition and alliance. It was not new in itself – Bijapur and Golconda had kept up embassies with the Safavids and the Ottomans – but no Deccan ruler had reached so far for so much. It also shows the danger of the attempt: in a region where the Company was becoming the arbiter of who might deal with whom, correspondence with a European rival could itself be made a casus belli. The Salbai clause excluding other Europeans had become a principle.",
  "sources": [
   {
    "title": "Kate Brittlebank, Tipu Sultan's Search for Legitimacy: Islam and Kingship in a Hindu Domain (Oxford University Press, Delhi, 1997)",
    "url": "https://catalog.hathitrust.org/Record/004015625"
 ...
 },
 {
  ...
  "lat": 13.417,
  "lon": 75.253,
  "strap": "In April 1791 Maratha irregulars sacked the Sringeri matha; the Swami turned to Tipu Sultan, whose letters ordering its restoration, found in 1916, are the best-documented act of his religious policy.",
  "body": "<p>Sringeri, on the Tunga in the Malnad, was the oldest of the mathas that trace themselves to Shankara, and its Jagadguru was the most eminent Hindu prelate in Mysore. In April 1791, in the second year of the Third Anglo-Mysore War, the Maratha army under Parashuram Bhau Patwardhan was moving through the Malnad as the Company’s ally, and a body of the irregulars attached to it – pindaris and Lamanis, the camp’s unpaid followers, with a Patwardhan detachment under Raghunath Rao of Kurundwad – fell on the matha. They plundered its treasury and granaries, killed a number of Brahmins and others, carried off an elephant and the ornaments of the shrine, and threw down the image of Sharada. The Swami, Sacchidananda Bharati, fled. The Marathas’ own letters, printed by Khare, record the Peshwa’s displeasure and Nana Phadnavis’s orders for restitution, which followed slowly and in part.</p>\n<p>The Swami wrote to Tipu. Some thirty of Tipu’s replies, in Kannada, with the orders they carried to his officers, were found in the matha’s records and published by the Mysore Archaeological Department in 1916. They express the sultan’s outrage in the language of dharma – people who had sinned against so holy a place were sure to suffer for it in this Kali age – direct the Asaf of Bednur to supply money and grain for the re-consecration of the image, ask the Swami to perform rites for the prosperity of the state, and continue in the same tone of respect to the end of the reign. Earlier grants by Haidar and Tipu to the matha are on record, and so are Tipu’s gifts to the temples of Srirangapatna, Melkote and Nanjangud.</p>\n<p>What the letters prove is narrower than either side of the modern argument wants. They do not cancel the deportations from Coorg and Malabar, or the destruction recorded in Company and Nair accounts; they show a ruler at war treating the great institution of his Hindu subjects as a source of legitimacy and of prayer for victory – kingship as an idiom to be mastered, as Brittlebank reads it, rather than a creed to be imposed, of a piece with his <a href=\"#tipu-reforms\">regulations</a> and his <a href=\"#tipu-embassies\">embassies</a>. The raid, for its part, was the work of the Deccan’s plural military market: the army that sacked Sringeri was the ally of the Company that would storm Srirangapatna, and its irregulars answered to no one.</p>",
  "story": "",
  "sources": [
   {
    "title": "Kate Brittlebank, Tipu Sultan’s Search for Legitimacy: Islam and Kingship in a Hindu Domain (Oxford University Press, Delhi, 1997)",
   ...
   {
    "title": "B. A. Saletore, ‘Tipu Sultan as Defender of the Hindu Dharma’, in Irfan Habib (ed.), Confronting Colonialism: Resistance and Modernization under Haidar Ali and Tipu Sultan (Anthem Press, London, 2002)",
    "url": "https://anthempress.com/books/confronting-colonialism-hb"
   },
   {
    "title": "V. V. Khare (ed.), Aitihasik Lekh Sangraha, vol. 9 (Miraj, 1911–1926), the Maratha correspondence of 1791–92",
    "url": "https://search.worldcat.org/search?q=Khare+Aitihasik+Lekh+Sangraha"
   },
   {
    "title": "Wikipedia, ‘Sringeri Sharada Peetham’",
 ...
 },
 {
  ...
  "title": "Munro and the Ceded Districts",
  "date_label": "1800–1807",
  "year": 1800,
  "year_end": 1807,
  "period": 6,
  "polities": [
  ...
  "lat": 15.14,
  "lon": 76.92,
  "strap": "The districts the Nizam surrendered to the Company in 1800 as the price of its protection, and the collector who settled them field by field with the cultivator himself: the ryotwari system that Madras adopted and that Bombay argued with for fifty years.",
  "body": "<p>By the treaty of 12 October 1800 the Nizam gave up to the Company the territory he had received in the partitions of Mysore in 1792 and 1799 – the country between the Tungabhadra and the Penner that became the Ceded Districts of Bellary and Cuddapah – in return for an enlarged subsidiary force he would no longer have to pay for. It was a raw acquisition: poligar chiefs in their forts, a revenue system disordered by Haidar, Tipu and the Nizam’s farmers in turn, and no Company officer who had governed there. Thomas Munro, a Scottish officer who had spent seven years under Alexander Read settling the Baramahal after 1792, arrived in October 1800 as principal collector, with four assistants and a country of about 27,000 square miles. He reduced the poligars in his first two years, some by pension and several by force, and then did what he had begun to do in the Baramahal: he settled the revenue with each cultivator directly, on a field-by-field survey and assessment, with no intermediary between the ryot and the state.</p>\n<p>Ryotwari, as the system came to be called, was a theory of Indian society as much as a method of collection. Munro held that the village and its headman were the ancient institutions of the country, that the zamindars of Bengal and the revenue farmers of the sultanates were parasites upon them, and that the state should deal with the peasant proprietor, assess him moderately and for a fixed term, and leave the village to run itself. His reports from the Ceded Districts, written in the plain and confident prose that made him the most quoted of Company administrators, went to Madras and to London and into the Fifth Report of 1812. Madras adopted the system for the whole presidency in the 1820s, when Munro returned as governor; he died of cholera on tour at Pattikonda, in the Ceded Districts, in July 1827.</p>\n<p>Bombay took the argument and not the method. Elphinstone read Munro’s reports and shared his respect for the village, but the Deccan the Company took in 1818 was full of hereditary rights – watans, inams, saranjams – for which Munro’s theory had no place. <a href=\"#pringle-wingate-survey-1835\">The survey</a> that Pringle began in the 1820s tried to apply a Ricardian version of the ryotwari assessment and failed; the settlement Goldsmid and Wingate made from 1835 was ryotwari in principle and something more complicated in practice. The Ceded Districts are where the paramount power first tried to reach past every intermediate layer to the man who held the plough; the Bombay Deccan is where it discovered how many layers there were.</p>",
  "story": "",
  "sources": [
   {
    "title": "Burton Stein, Thomas Munro: The Origins of the Colonial State and His Vision of Empire (Oxford University Press, Delhi, 1989)",
   ...
   {
    "title": "T. H. Beaglehole, Thomas Munro and the Development of Administrative Policy in Madras, 1792–1818 (Cambridge University Press, 1966)",
    "url": "https://search.worldcat.org/search?q=Beaglehole+Thomas+Munro+and+the+Development+of+Administrative+Policy+in+Madras"
   },
   {
    "title": "Wikipedia, ‘Thomas Munro’",
    "url": "https://en.wikipedia.org/wiki/Thomas_Munro"
   },
   {
    "title": "Wikipedia, ‘Ceded Districts’",
 ...
 },
 {
  ...
  "body": "<p>Pune passed to the Company in November 1817 and was formally annexed in 1818. Within months the army laid out a cantonment on open ground east of the city, beyond the old town, with a second at Khadki to the north where the battle of 1817 had been fought. The cantonments brought a garrison, barracks, a bazaar, a church and a European population that lived apart from the Peshwa’s city of wadas and temples. The Collector’s office and courts were established, and the districts of the Desh were administered from Pune under the Deccan Commission and then, from 1826, as part of the Bombay Presidency. In the decades that followed the governors of Bombay took to spending the monsoon months in Pune.</p>\n<p>The city itself was left largely alone. The Shaniwar Wada, seat of the Peshwas since 1732, was occupied by the Company; on 27 February 1828 a fire broke out inside it and burned for seven days, leaving the granite ramparts and teak gateways standing over a ruin. The cause was never explained. In 1821 Elphinstone diverted part of the dakshina, the fund from which the Peshwas had given annual gifts to learned Brahmins, to found the Hindoo College, later the Poona Sanskrit College and in time Deccan College. The great Brahmin families of the city kept their wadas and many of their inams, and some of their sons entered Company service.</p>\n<p>By the 1830s Pune was two towns side by side: the old Maratha city on the river and the camp on the plain. It remained the centre of Brahmin learning and political memory in western India, which is why its later history in the century runs so differently from Bombay’s.</p>",
  "story": "",
  "sources": [
   {
 ...
 },
 {
  ...
  "body": "<p>In the second half of 1830 cultivators in the Nagar division of Mysore, the hilly country around the old Keladi capital of Bidnur, refused to pay their revenue and rose against the raja’s officers. The grievances were fiscal: a new system of revenue farming, the shurtee and sayar, had multiplied intermediaries and illegal collections, and the raja’s court, which had spent freely since Krishnaraja Wodeyar III took up the government in 1810, was pressing for money. The largely Lingayat peasantry also resented the Brahmin officers set over them. A pretender, Budi Basappa, who claimed the Keladi throne on the strength of forged documents and stolen seals, gave the rising a leader. The revolt spread through the Malnad in the winter of 1830 to 1831.</p>\n<p>The raja’s troops could not suppress it, and Company forces from Bengaluru were brought in. The fighting was over by June 1831 and the reprisals were severe; some ninety-nine rebels were executed at Honnali in March, and the total number of rebels executed was put at 164 by the Mysore government and at 240 by the later committee of inquiry. The Governor-General, Lord William Bentinck, treated the revolt as proof that the raja’s government had failed within the meaning of the 1799 treaty. On 19 October 1831 the raja was required to hand over the administration. Mysore was placed under a Commission, at first of several officers and from 1834 under Mark Cubbon alone, who governed it until 1861. Krishnaraja kept his title, his palace and an allowance.</p>\n<p>A committee of inquiry later reported that the rising had been agrarian and not dynastic, and the raja spent decades petitioning for his state. British direct rule lasted until 1881, when Mysore was handed back to his adopted heir.</p>",
 ...
 },
 {
  ...
  "body": "<p>By the treaty of 21 May 1853 the Nizam, Nasir ud-Daula, assigned to the Company the province of Berar, together with the Raichur Doab and the Dharaseo (Osmanabad) districts, territories to yield about fifty lakhs of rupees a year. In return the Company took over the maintenance of the Hyderabad Contingent, the force raised and officered by the British in the Nizam’s name since 1813 to meet his obligations under the treaty of 1800, and released the Nizam from the arrears he owed for it. The districts remained nominally Hyderabad’s, but were administered by British officers under a Commissioner, and their surplus revenue was to be accounted for to the Nizam.</p>\n<p>The debt had been building for two decades. The Contingent cost some forty lakhs a year, the Nizam’s treasury was chronically short, and the Residency pressed him through the 1840s to pay or to cede territory in lieu. Dalhousie, who held that the Contingent was the Nizam’s own force under the treaty and that Hyderabad must pay for it, forced the matter. The Nizam’s ministers resisted the cession of Berar in particular, and signed under pressure. In 1860 a further treaty, negotiated by the young minister Salar Jang after the Nizam’s conduct in 1857, restored Raichur and Dharaseo to Hyderabad and cancelled a fifty-lakh debt, but left Berar in British hands, held in trust for the purposes of the 1853 treaty. In 1902 the assignment became a perpetual lease.</p>\n<p>The assignment changed the shape of Hyderabad without formally touching its sovereignty. Berar was the cotton country of the Deccan, and its transfer just before the American Civil War sent the cotton boom of the 1860s to the Company rather than the Nizam. The Nizam remained a sovereign prince with a British-paid army stationed in his dominions, a Resident in his capital and his best revenue collected by someone else. This was what paramountcy looked like for the one Deccan state that was never annexed.</p>",
 ...
 {
  "id": "nagpur-bhonsles-lapse-1853",
  "title": "Nagpur, from Raghuji to the lapse",
  "date_label": "1743–1854",
  "year": 1853,
  "year_end": 1854,
  "period": 7,
  "polities": [
  ...
  "lat": 21.15,
  "lon": 79.09,
  "strap": "The fourth Maratha house, which ruled Berar and the Gond country from Nagpur for a century, raided Bengal, fought the Company at Sitabaldi, and ended in December 1853 as the largest of the states taken by lapse.",
  "body": "<p>Raghuji Bhonsle, a kinsman of the Chhatrapati’s family whom Shahu made Senasahibsubha in 1728, took Nagpur from the Gond raja of Deogarh in the 1740s and made it the capital of a state that ran from Berar across the Gondwana forests to Orissa. His horsemen raided <a href=\"#maratha-confederacy\">Bengal from 1742</a> until Alivardi Khan bought them off in 1751 with Orissa and the chauth of Bengal. The house was one of the four great sardar families of the confederacy, but the one that stayed a Deccan power, on the plateau’s north-eastern edge between Hyderabad and the Ganges plain. Raghuji died in 1755; his sons quarrelled; and Nagpur settled into the shape it kept for sixty years, a Maratha court ruling a country that was largely Gond, Telugu and Oriya, with Berar’s cotton revenue as its treasury and the Nizam and the Peshwa as its rivals.</p>\n<p>The house met the Company’s armies twice. In 1803 Raghuji II marched with Scindia and shared the defeats at <a href=\"#assaye-1803\">Assaye</a> and Argaon; the Treaty of Deogaon in December took Cuttack and the country west of the Wardha from him, and the Nizam received the Berar districts. In November 1817 his nephew and successor Appa Sahib, secretly in league with the Peshwa, attacked the Residency; the two-day battle on the Sitabaldi hills, held by a small force of Madras sepoys, was the eastern front of the Third Maratha War. Appa Sahib was deposed the next year, and the Company put a boy, Raghuji III, on the gadi under a Resident, Richard Jenkins, who governed in his name until 1830 and then handed him a state whose army and foreign relations were already the Company’s.</p>\n<p>Raghuji III died on 11 December 1853 without a son and without having adopted one. His widows proposed an adoption; Dalhousie declined to recognise one made after the raja’s death and declared the state lapsed to the paramount power, on the doctrine that had taken <a href=\"#satara-lapse-1848\">Satara</a> five years earlier. Nagpur became a Company province in 1854 and, joined to the Saugor and Nerbudda territories, the Central Provinces in 1861; the raja’s jewels, horses and elephants were sold at auction, which was remembered. Of the four houses of the confederacy Nagpur was the only one to disappear. Holkar, Scindia and the Gaekwad survived 1858 as princes because they had heirs, treaties and, in 1857, the sense to stay loyal.</p>",
  "story": "",
  "sources": [
   {
    "title": "Stewart Gordon, The Marathas 1600–1818 (The New Cambridge History of India, II.4) (Cambridge University Press, 1993)",
   ...
   {
    "title": "C. U. Wills, British Relations with the Nagpur State in the 18th Century: An Account, Mainly Based on Contemporary English Records (Government Press, Nagpur, 1926)",
   ...
   {
    "title": "Wikipedia, ‘Kingdom of Nagpur’",
 ...
 },
 {
  ...
  "title": "Black soil and the bonds",
  "date_label": "1847–1875",
  "year": 1865,
  "year_end": 1875,
  "period": 7,
  "polities": [
  ...
  "kind": "place",
  "place": "Sholapur, Maharashtra",
  "lat": 17.68,
  "lon": 75.91,
  "strap": "The Traps weather into a black clay that holds water and grows cotton; the survey put a price on it, the American war put a market under it, and the debt that followed the market is what the Riots Commission found in the moneylenders’ bonds.",
  "body": "<p>The Deccan’s history in the last period of this collection was written on one soil. Where the Traps have weathered in a dry climate they leave regur – the <a href=\"https://naniwadekar.com/basalt-and-laterite/#regur-black-soil\">black cotton soil</a> of the companion collection – a deep, cracking clay that swells in the rains, holds moisture through the dry months and will carry a crop with no more water than falls on it. It floors Khandesh, Berar, the Nagpur country, Marathwada and the southern Maratha districts from Sholapur to Bijapur, and it spills south onto the limestones of the Bhima. It is the soil of cotton, and cotton is why the plateau’s villages had a cash crop before they had a cash economy.</p>\n<p>The Company measured it first. The revenue survey that Goldsmid and Wingate began in 1835 and codified in the Joint Report of 1847 was, before it was anything else, a survey of soil: every field was measured and its soil classed by colour and depth, black above red above the thin ‘barad’ of the uplands, and the assessment was fixed on the class for thirty years. The old regimes had taxed a village’s share of the harvest; the new one taxed a field’s share of the geology, in cash, on a date. Then the American Civil War closed the Lancashire mills’ supply in 1861 and Bombay’s buyers came up the ghats for whatever the black soil would grow. Berar, assigned to the Company in 1853 and reached by rail in the same decade, became the cotton province of India; the Deccan’s older varieties and the American seed that Dharwar had grown since the 1840s went out through Bombay at prices no one had seen. Land was ploughed that had never been, credit followed the price into every taluka, and for four years the regur was the most valuable ground in the peninsula.</p>\n<p>The tide went out in 1865. Prices fell by half; the thirty-year settlements of the 1830s came up for revision in the same years, and the revised assessments of Indapur and its neighbours were raised; the seasons of the early 1870s were poor. The debts contracted in the boom had been secured, under the new courts, on the land itself, and the moneylender who had lent against a cotton price now held bonds against fields. The Riots of May and June 1875 broke out not in the deep black soil of Berar but on its thin margin – Bhimthadi, Indapur, Supa, Parner, the talukas of Poona and Ahmednagar where the regur gives way to lighter ground and a cash assessment on a fixed date is hardest to meet. The cultivators burned the bonds, not the moneylenders; they wanted the paper.</p>\n<p>What the Commission of 1876 described, without quite saying so, was a chain that ran from the rock to the register. The Traps made the soil; the soil grew the cotton; the survey classed the soil and fixed the demand; the war priced the cotton; the courts made the price into debt; and the debt, when the price fell, became the bonds in the moneylender’s house. Every link in it is an entry in one of this site’s two collections, and none of them explains the riots alone.</p>",
  "story": "This is where the plateau’s two histories meet on one field. The audit of the last period – the survey, the Inam Commission, the Watan Act – was in the end a reckoning of the soil: who held which class of it, what it owed, and to whom. The Riots are the black soil answering.",
  "sources": [
   {
    "title": "Sumit Guha, The Agrarian Economy of the Bombay Deccan, 1818–1941 (Oxford University Press, 1985)",
    "url": "https://archive.org/details/agrarianeconomyo0000sumi"
