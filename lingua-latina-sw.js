/* Lingua Latina — offline service worker
   Page-specific service worker for /lingua-latina.html.
   Online visits use the newest HTML; offline visits use the last cached copy.
*/

"use strict";

const CACHE_PREFIX = "lingua-latina-";
const CACHE_VERSION = "v3";
const CACHE_NAME = `${CACHE_PREFIX}${CACHE_VERSION}`;

const APP_PAGE = "/lingua-latina.html";

const APP_ASSETS = [
  APP_PAGE,
  "/lingua-latina-manifest.json",
  "/lingua-latina-icon-180.png",
  "/lingua-latina-icon-192.png",
  "/lingua-latina-icon-512.png"
];
...
self.addEventListener("activate", event => {
  event.waitUntil(
    (async () => {
      ...
      /*
        Delete only older Lingua Latina caches.
    ...
    return (
      ...
      new Response(
        "<!doctype html>" +
          ...
          "<title>Lingua Latina offline</title>" +
          "</head>" +
          "<body>" +
