...
(function () {
  ...
  function home() {
    ...
    app.innerHTML = '<div class="wrap">' +
      ...
      '<p class="measure muted">The story is told through seven periods, from the Peninsular Gneiss to the first geologists. Click a marker on the band or browse the periods below; every entry has its own page, with sources; where the deep history surfaces in the human record, an entry also links into the companion <a href="' + DEC + '" target="_blank" rel="noopener">Deccan timeline</a>. Positions on the band are on a logarithmic scale – deep time does not fit a ruler.</p>' +
